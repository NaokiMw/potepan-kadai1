...
function timer(){
    ...
    const second = nos ?(nos  % 86400 % 3600 %60) :"0";
    const minute = nos > 60 ? (Math.trunc(nos % 86400 % 3600 / 60)):"0";
    const hour = nos >360 ? (Math.trunc(nos % 86400 / 3600)):"0";
    if(progress < 86400){
        record.textContent = hour + ":" + minute + ":" + second + ":" + millisecond;}
        else{record.textContent = "0:0:0:0",clearInterval(stop);}},10);
}
